...
This archive contains the codes used to produce the figures used in *What we do in the shadows: using light attenuation to observe mesopelagic ecosystems* by Alice Della Penna, Camrin D. Braun, Joanne O'Callaghan, Christophe Guinet, Moninya Roughan, Christina Schallenberg, and Martin C. Arostegui to be submitted soon.
